...
function BentoTilt({ children, className }: { children: React.ReactNode, className: string }) {
  ...
  function handleMouseMove(e: MouseEvent<HTMLDivElement>) {
    ...
    const transformStyles = `perspective(700px) rotateX(${tiltX}deg) rotateY(${tiltY}deg) scale3d(0.96, 0.96, 0.96)`;
  ...
  return (
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className="border-hsla relative mb-7 h-96 w-full overlow-hidden rounded-md md:h-[65vh]">
          <BentoCard
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
              ...
              title={<>n<b>e</b>xus</>}
              description="A gamified social hub, adding a new dimenstion of play to social interaction for Web3 communities."
            />
          </BentoTilt>
          ...
          <div className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
              <h1 className="bento-title special-font max-w-64 text-black"><b>M</b>ore co<b>m</b>ing so<b>o</b>n!</h1>
